  ...
  return (
    <div className="bg-white shadow-lg shadow-gray-300  flex justify-between items-center px-4  sticky top-0 ">
      ...
      <div className="flex space-x-6 font-semibold">
        ...
        <a
          href="/signUp"
          className="border-2 border-yellow hover:bg-purple v hover:border-purple hover:text-white   px-5 py-2  rounded-full transition delay-100 duration-150 ease-in-out hover:-translate-y-1 hover:scale-100"
        >
          Sign up
        </a>
      </div>
